...
import '../controller/WebviewController.dart';
import '../modles/ChallenegeListModel.dart';
import 'PaymentfailedScreen.dart';

class Webpaymentchallenge extends StatefulWidget {
  String name;
  String Number;
...
class _WebViewTextExtractionState extends State<Webpaymentchallenge> {
                              ...
                              if (status.toLowerCase() == "true") {
                                ...
                                Get.to(
                                  PaymentsuccessScreen(
                                    isShare: AppData.volunteerId == null
                                        ? 1
                                        : 0,
                                    name: widget.name,
                                  ),
