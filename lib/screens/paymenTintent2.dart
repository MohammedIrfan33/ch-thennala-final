...
import '../controller/PaymentController2.dart';
import '../controller/PaymentIntentcontroller.dart';
import '../modles/ModelClosePayment.dart';

class Paymentintent2 extends StatefulWidget {
  ...
  @override
  State<Paymentintent2> createState() => _PaymentintentState();
}

class _PaymentintentState extends State<Paymentintent2>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (_getxcontroller.paymentLaunched &&
      ...
      _getxcontroller.CheckThePayment(widget.model.orderId);
    }
  }
  ...
  final _getxcontroller = Get.put(Paymentcontroller2());
